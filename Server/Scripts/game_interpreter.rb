...
class Game_Interpreter
  ...
  def change_item
    ...
    return if @client.full_inventory?($data_items[@params[0]]) && value > 0
  ...
  def change_weapon
    value = operate_value(@params[1], @params[2], @params[3])
    return if @client.full_inventory?($data_weapons[@params[0]]) && value > 0
  ...
  def change_armor
    value = operate_value(@params[1], @params[2], @params[3])
    return if @client.full_inventory?($data_armors[@params[0]]) && value > 0
