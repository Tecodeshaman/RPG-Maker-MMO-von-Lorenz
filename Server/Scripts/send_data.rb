...
# ** Send_Data
#------------------------------------------------------------------------------
#  Este módulo envia as mensagens para o cliente.
#------------------------------------------------------------------------------
#  Autor: Valentine
#==============================================================================
...
module Send_Data
	...
	def global_message(message, color = Constants::CHAT_GLOBAL)
		buffer = Buffer_Writer.new
		buffer.write_byte(Constants::PACKET_CHAT_MSG)
		buffer.write_byte(color)
		buffer.write_string(message)
		send_data_to_all(buffer.to_s)
	end

	def party_message(client, message, color = Constants::CHAT_PARTY)
